/** \mainpage
	...
	<ol>
		<li>
			<b><i>Wally</i>: Wheeled autonomous robot (1-wheeled-rob/main.c):</b><br>
		...
		<li>
			<b><i>Squid</i>: Non-wheeled remote-controlled and autonomous robot (2-nonwheeled-rob/main.c):</b><br>
		...
		<li>
			<b><i>Shark</i>: Toy robot (4-toy-robot/main.c):</b><br>
